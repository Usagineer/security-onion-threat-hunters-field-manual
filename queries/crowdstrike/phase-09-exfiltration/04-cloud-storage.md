# Exfiltration — Cloud Storage (general) - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **cloud storage** to identify staging and transfer of collected data. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
| DomainName=/(dropbox|drive\.google|onedrive|sharepoint|box|mega|pcloud|sync)\./i
