# Exfiltration — Mega - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **mega** to identify staging and transfer of collected data. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
| DomainName=/(mega\.nz|mega\.io|mega\.co\.nz)$/i
