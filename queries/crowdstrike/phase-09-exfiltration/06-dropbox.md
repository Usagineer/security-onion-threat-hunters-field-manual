# Exfiltration — Dropbox - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **dropbox** to identify staging and transfer of collected data. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
| DomainName=/(dropbox\.com|dropboxapi\.com|dropboxusercontent\.com)$/i
