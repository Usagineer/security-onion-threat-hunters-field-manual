# Lateral Movement — DCOM - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **dcom** to identify movement from one system or account to another. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
| ImageFileName=/(MMC20\.Application|ShellWindows|ShellBrowserWindow|DCOM.*ComputerName)/i OR CommandLine=/(MMC20\.Application|ShellWindows|ShellBrowserWindow|DCOM.*ComputerName)/i
