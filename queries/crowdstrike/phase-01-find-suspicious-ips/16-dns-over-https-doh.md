# DNS over HTTPS (DoH) - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **dns over https doh** to surface anomalous network infrastructure and communication patterns. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
| DomainName=/(dns\.google|cloudflare-dns\.com|dns\.quad9\.net|doh\.opendns\.com)$/i
