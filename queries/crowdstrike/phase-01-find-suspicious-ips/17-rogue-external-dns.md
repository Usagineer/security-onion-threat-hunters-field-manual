# Rogue / External DNS Servers - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **rogue external dns** to surface anomalous network infrastructure and communication patterns. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
| RemotePort=/^53$/ | RemoteAddressIP4!=/^(10\.0\.0\.10|10\.0\.0\.11)$/
...
- Replace the example resolver IPs with the approved resolver set.
