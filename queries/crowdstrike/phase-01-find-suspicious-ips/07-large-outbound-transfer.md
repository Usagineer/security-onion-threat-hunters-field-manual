# Large Outbound Transfer (Exfil) - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **large outbound transfer** to surface anomalous network infrastructure and communication patterns. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
