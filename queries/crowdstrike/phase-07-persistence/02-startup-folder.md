# Persistence — Startup Folder - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **startup folder** to identify mechanisms that preserve attacker access. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
| ImageFileName=/(\\Start Menu\\Programs\\Startup\\|shell:startup|shell:common startup)/i OR CommandLine=/(\\Start Menu\\Programs\\Startup\\|shell:startup|shell:common startup)/i
