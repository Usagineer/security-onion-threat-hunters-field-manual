# Persistence — Scheduled Tasks - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **scheduled tasks** to identify mechanisms that preserve attacker access. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
