# Event 4720 — User Account Created - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **user account created** to investigate Windows and Active Directory security events. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
