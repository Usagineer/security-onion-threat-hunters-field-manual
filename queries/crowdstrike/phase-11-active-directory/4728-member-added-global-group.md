# Event 4728 — Member Added Global Group - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **member added global group** to investigate Windows and Active Directory security events. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
