# Found a suspicious IP -> run the Master IP Pivot - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **found suspicious ip** to continue from a confirmed lead into its surrounding activity. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
