# WinRM for this IP - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **winrm** to scope an IP lead across independent telemetry. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
| RemotePort=/^(5985|5986)$/ | RemoteAddressIP4=?{ip=*}
