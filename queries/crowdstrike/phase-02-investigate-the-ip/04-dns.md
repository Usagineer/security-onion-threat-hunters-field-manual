# DNS for this IP - CrowdStrike Next-Gen SIEM

## What this does

Hunts for **dns** to scope an IP lead across independent telemetry. The result keeps the endpoint, account, process, network peer, and time fields needed to validate the behavior and continue scoping.
...
- Add the `aid` and `ContextProcessId` obtained from the IP pivot.
